...
<div class="container">
    ...
    ?>
        ...
        <a href="cadastrarfilme.php" class="btn btn-dark">Adicionar novo filme</a>
        <table class="table">
    <thead>
        <tr>
            <th scope="col">ID</th>
    ...
    <tbody>
      ...
      <td>
        ...
        <a href="deletarfilme.php?id=<?php echo $row['id'] ?>" class="link-dark"><i class="fa-solid fa-trash 
        fs-5 me-3"></i></a>
      </td>     
    </tr> 
            <?php
