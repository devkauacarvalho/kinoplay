...
--
-- Host: 127.0.0.1
-- Tempo de geração: 01-Fev-2023 às 19:27
...
INSERT INTO `filmes` (`id`, `titulo`, `anoLancamento`, `Genero`, `sinopse`, `Imagem`, `Classificacao`, `Nota`, `Trailer`) VALUES
...
INSERT INTO `series` (`Id`, `Titulo`, `anoLancamento`, `Generos`, `sinopse`, `imagem`, `Classificacao`, `nota`, `Trailer`) VALUES
...
--
ALTER TABLE `genero`
  MODIFY `IdGenero` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
ALTER TABLE `favoritos`
  ...
  ADD CONSTRAINT `fk_id_usuario` FOREIGN KEY (`id_usuario`) REFERENCES `cliente` (`IdCliente`) ON UPDATE NO ACTION;
COMMIT;
