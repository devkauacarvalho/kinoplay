...
(51, 'Vingadores: Ultimato', '2019', 'Após os eventos devastadores de Vingadores: Guerra Infinita, o Universo entrou em destruição por causa do Estalar de Dedos do Thanos, o Titã Louco. Com a ajuda dos heróis sobreviventes, os Vingadores devem se reunir mais uma vez para desfazer as ações de Thanos e restaurar a ordem do universo de uma vez por todas, não importa quais serão as consequências que os aguardam.', 'img/banner-destaque/avengers.jpg', '12', '4,3', 'https://www.youtube.com/embed/gosFJSkg-gk', 1),
(52, 'Avatar: O Caminho da Água', '2022', 'Doze anos depois de explorar Pandora e se juntar aos Navi, Jake Sully formou uma família com Neytiri e se estabeleceu entre os clãs do novo mundo. No entanto, o retorno de um antigo conhecido em busca de vingança faz com que seja necessária uma brusca mudança para o casal e seus filhos, agora que a guerra está declarada.', 'img/banner-destaque/avatar2.jpg', '14', '4.1', 'https://www.youtube.com/embed/x5pZI-DmtrE ', 1),
(53, 'Venom', '2018', 'Eddie Brock (Tom Hardy) é um jornalista que investiga o misterioso trabalho de um cientista, suspeito de utilizar cobaias humanas em experimentos mortais. Quando ele acaba entrando em contato com um simbionte alienígena, Eddie se torna Venom, uma máquina de matar incontrolável, que nem ele pode conter.', 'img/banner-destaque/venom.jpg', '14', '3,1', 'https://www.youtube.com/embed/EQxCycVTfcU', 1);
