...
--
-- Host: 127.0.0.1
-- Tempo de geração: 30-Jan-2023 às 01:06
...
(41, 'Pantera Negra Wakanda para sempre', '0000-00-00', 0, 0, 'Rainha Ramonda, Shuri, M\'Baku, Okoye e Dora Milaje lutam para proteger sua nação das potências mundiais intervenientes após a morte do rei T\'Challa.', 'img/film-cards/wakanda.jfif', 14, 'https://youtu.be/oHDi01Yn4tY'),
(42, 'Se Beber, Não Case', '0000-00-00', 0, 0, 'Dois dias antes de seu casamento, Doug e três amigos vão de carro até Las Vegas para uma louca e memorável despedida de solteiro. Quando os três padrinhos acordam na manhã seguinte, eles não conseguem se lembrar de nada e notam que Doug desapareceu. Com pouco tempo de sobra, os amigos tentam refazer a noite anterior e encontrar Doug para que possam levá-lo de volta a Los Angeles a tempo de chegar ao altar.', 'img/film-cards/case.jfif', 14, 'https://youtu.be/jOQMBfWMMsU'),
(43, 'American Pie', '0000-00-00', 0, 0, 'Jim Levenstein, Kevin Myers, Oz Ostreicher e Paul Finch são quatro amigos virgens às vésperas do baile de formatura. Em meio a suas tentativas frustradas de fazer sexo com as namoradas, olhar mulheres nuas na internet e até mesmo atacar uma torta recém-saída do forno, os rapazes fazem um pacto e prometem deixar a virgindade para trás antes do baile de formatura. Agora eles têm 24 horas para cumprir esse acordo.', 'img/film-cards/pie.jfif', 16, 'https://youtu.be/2x3oJ3TOZmk'),
(44, 'Adão Negro', '0000-00-00', 0, 0, 'O poderoso Adão Negro é libertado de sua tumba para lançar sua justiça cruel sobre a Terra.', 'img/film-cards/Adao.jfif', 14, 'https://youtu.be/HluMG9tJXHM'),
(45, 'Sniper Americano', '0000-00-00', 0, 0, 'Chris Kyle é um atirador de elite das forças especiais da marinha dos Estados Unidos. Durante a Guerra do Iraque, sua missão é proteger seus companheiros e seu dever faz dele um dos maiores atiradores da história norte-americana. Sua precisão salva inúmeras vidas, mas também o torna um alvo preferencial. Quando Kyle finalmente volta para casa, ele descobre que não tem como deixar a guerra para trás.', 'img/film-cards/Sniper.jfif', 16, 'https://youtu.be/ztUAnmhwCWU'),
(46, 'Rastros de um Sequestro', '0000-00-00', 0, 0, 'Um homem é raptado e retorna depois de 19 dias sem nenhuma memória do que aconteceu. Então seu irmão, Jin-seok, tenta descobrir a verdade sobre seu desaparecimento.', 'img/film-cards/sequestro.jfif', 16, 'https://youtu.be/OSgX2EHAxOU'),
(47, 'O Ovo da Serpente ', '0000-00-00', 0, 0, 'Berlim, novembro de 1923. Abel Rosenberg é um trapezista judeu desemprego, que descobriu recentemente que seu irmão, Max, se suicidou. Logo ele encontra Manuela, sua cunhada. Juntos eles sobrevivem com dificuldade à violenta recessão econômica pela qual o país passa. Sem compreender as transformações políticas em andamento, eles aceitam trabalhar em uma clínica clandestina que realiza experiências em seres humanos.', 'img/film-cards/serpente.jfif', 16, 'https://youtu.be/3Ibo99NwTJo'),
(48, '007: Um Novo Dia Para Morrer', '0000-00-00', 0, 0, 'Após se libertar de uma prisão na Coreia do Norte, James Bond entra em ação para perseguir o maligno Gustav Graves, que está desenvolvendo uma arma de alta tecnologia capaz de colocar o mundo em risco.', 'img/film-cards/007.jfif', 12, 'https://youtu.be/kCyjw0z-5KI'),
(49, 'Missão: Impossível 3', '0000-00-00', 0, 0, 'Aposentado do serviço ativo e treinando recrutas para a Força Missão Impossível, o agente Ethan Hunt enfrenta o inimigo mais difícil de sua carreira: Owen Davian, um negociante internacional de armas e informação que é tão esperto quanto implacável. Davian surge para ameaçar Hunt e tudo o que ele mais estima, incluindo a mulher que tanto ama.', 'img/film-cards/impossivel.jfif', 14, 'https://youtu.be/0ypddYNLvvQ'),
(50, 'Os Pinguins do Papai ', '0000-00-00', 0, 0, 'Popper é um executivo de sucesso que não tem muito tempo para a família. Mas seu destino muda quando ele recebe seis pinguins de herança do pai, transformando seu apartamento luxuoso em um habitat para os animais.', 'img/film-cards/Pinguins.jfif', 10, 'https://youtu.be/uAqriksZ81o');
