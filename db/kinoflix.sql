...
(3, 'Park Solomon', 'img/ator-cards/Park Solomon.jpg', 'All of us Are Dead', NULL, 41),
...
(11, 'Emma Roberts', 'img/ator-cards/Emma Roberts.jpg', 'American Horror Story', NULL, 17),
...
(63, 'Itzan Escamila', 'img/ator-cards/Itzan Escamila.jpg', 'Elite', NULL, 15),
...
(70, 'Zendaya', 'img/ator-cards/Zendaya Coleman.png', 'Euphoria', NULL, 9),
(71, 'Carol Daronch', 'img/ator-cards/Carol Daronch_jovem.jpg', 'Falando com um serial killer teddy bundy', NULL, 2),
...
(76, 'David Schwimmer', 'img/ator-cards/David Schwimmer.jpg', 'Friends', NULL, 31),
...
(109, 'Miyavi', 'img/ator-cards/Miyavi.jpg', 'Invencivel', NULL, 39),
(110, 'Alba Flores', 'img/ator-cards/Alba Flores.jpg', 'La casa de papel', NULL, 11),
...
(146, 'Agnes Gobbleblobber', 'img/ator-cards/Agnes Gobbleblobber - Barbara Goodson.jpg', 'Mr. Pickles', NULL, 50),
(147, 'Mrs. Goodman', 'img/ator-cards/Mrs. Goodman - Brooke Shields.jpg', 'Mr. Pickles', NULL, 50),
(148, 'Stanley Goodman', 'img/ator-cards/Stanley Goodman - Jay Johnston.jpg', 'Mr. Pickles', NULL, 50),
(149, 'Superhero Guy', 'img/ator-cards/Superhero Guy - Will Carsola.jpg', 'Mr. Pickles', NULL, 50),
(150, 'Tommy Goodman', 'img/ator-cards/Tommy Goodman - Kaitlyn Robrock.jpg', 'Mr. Pickles', NULL, 50),
...
(183, '', 'img/ator-cards/.jpg', 'Ratched', NULL, 45),
...
(232, 'Matt Smith', 'img/ator-cards/Matt Smith.jpg0', 'The crown', NULL, 16),
(233, 'Emma Corrin', 'img/ator-cards/Emma Corrin2.jpg', 'The crown', NULL, 16),
(234, 'Vanessa Kirby', 'img/ator-cards/Vanessa Kirby.png', 'The crown', NULL, 16),
(235, 'Helena Bohan Carter', 'img/ator-cards/Helena Bohan Carter.jpg', 'The crown', NULL, 16),
(236, 'Olivia Coleman', 'img/ator-cards/Olivia Coleman.jpg', 'The crown', NULL, 16),
...
(242, 'Marcia Warren', 'img/ator-cards/Marcia Warren.jpg', 'The crown', NULL, 16),
...
(259, 'Jeffrey Dean Morgan', 'img/ator-cards/Jeffrey Dean Morgan.png', 'The walking dead', NULL, 26),
...
(270, 'Gustaf Skarsgard', 'img/ator-cards/Gustaf Skarsgard.jpg', 'Vikings', NULL, 20),
...
(302, 'Lupita Nyong`o', 'img/ator-cards/Lupita Nyong_o.png', '12 anos de escravidão', 21, NULL),
...
(333, 'Mauricio Fiore', 'img/ator-cards/Mauricio Fiore.png', 'Cracolândia', 14, NULL),
...
(355, 'Will Poulter', 'img/ator-cards/Will Poulter.png', 'O Regresso', 17, NULL),
...
(402, 'Zoe Kazan', 'img/ator-cards/Zoe Kazan.jpg', 'Young Sheldon', NULL, 24),
...
(407, 'Miriam Lenoe', 'img/ator-cards/Miriam Lenoe.png', 'Jogada de Amor', 1, NULL),
(408, 'Pierfrancesco', 'img/ator-cards/Pierfrancesco.png', 'Jogada de Amor', 1, NULL),
(409, 'Piera Degli', 'img/ator-cards/Piera Degli.png', 'Jogada de Amor', 1, NULL),
(410, 'Pilar Fogliati', 'img/ator-cards/Pilar Fogliati.png', 'Jogada de Amor', 1, NULL),
(411, 'Sally Hawkins', 'img/ator-cards/Sally Hawkins.png', 'Jogada de Amor', 1, NULL),
(412, 'Doug Jones', 'img/ator-cards/Doug Jones.png', 'A Forma da Água', 2, NULL),
(413, 'Octavia Spencer', 'img/ator-cards/Octavia Spencer.png', 'A Forma da Água', 2, NULL),
(414, 'Richard Jenkins', 'img/ator-cards/Richard Jenkins.png', 'A Forma da Água', 2, NULL),
(415, 'Michael Shannon', 'img/ator-cards/Michael Shannon.png', 'A Forma da Água', 2, NULL),
(416, 'Vanessa Scalera', 'img/ator-cards/Vanessa Scalera.png', 'A Forma da Água', 2, NULL),
(417, 'Ryan Gosling', 'img/ator-cards/Ryan Gosling.png', 'La La Land: Cantando Estações', 3, NULL),
(418, 'J. K. Simmons', 'img/ator-cards/J. K. Simmons.png', 'La La Land: Cantando Estações', 3, NULL),
(419, 'John Legend', 'img/ator-cards/John Legend.png', 'La La Land: Cantando Estações', 3, NULL),
(420, 'Finn Wittrock', 'img/ator-cards/Finn Wittrock.jpg', 'La La Land: Cantando Estações', 3, NULL),
(421, 'Emma Stone', 'img/ator-cards/Emma Stone.png', 'La La Land: Cantando Estações', 3, NULL),
(422, 'Patrick Swayze', 'img/ator-cards/Patrick Swayze.png', 'Ghost do outro lado da vida', 4, NULL),
(423, 'Demi Moore', 'img/ator-cards/Demi Moore.png', 'Ghost do outro lado da vida', 4, NULL),
(424, 'Whoopi Goldberg', 'img/ator-cards/Whoopi Goldberg.png', 'Ghost do outro lado da vida', 4, NULL),
(425, 'Tony Goldwyn', 'img/ator-cards/Tony Goldwyn.png', 'Ghost do outro lado da vida', 4, NULL),
(426, 'Rick Aviles', 'img/ator-cards/Rick Aviles.png', 'Ghost do outro lado da vida', 4, NULL),
(427, 'Eddie Redmayne', 'img/ator-cards/Eddie Redmayne.png', 'A Teoria de Tudo', 5, NULL),
(428, 'Felicity Jones', 'img/ator-cards/Felicity Jones.png', 'A Teoria de Tudo', 5, NULL),
(429, 'Charlie Cox', 'img/ator-cards/Charlie Cox.png', 'A Teoria de Tudo', 5, NULL),
(430, 'Emily Watson', 'img/ator-cards/Emily Watson.png', 'A Teoria de Tudo', 5, NULL),
(431, 'David Thewlis', 'img/ator-cards/David Thewlis.png', 'A Teoria de Tudo', 5, NULL),
(432, 'Jeffrey Dean Morgan', 'img/ator-cards/Jeffrey Dean Morgan.png', 'Rogai por Nós', 24, NULL),
(433, 'Cricket Brown', 'img/ator-cards/Cricket Brown.png', 'Rogai por Nós', 24, NULL),
(434, 'Diogo Morgado', 'img/ator-cards/Diogo Morgado.png', 'Rogai por Nós', 24, NULL),
(435, 'Marina Mazepa', 'img/ator-cards/Marina Mazepa.png', 'Rogai por Nós', 24, NULL),
(436, 'Katie Aselton', 'img/ator-cards/Katie Aselton.png', 'Rogai por Nós', 24, NULL),
(437, 'Manuela Velasco', 'img/ator-cards/Manuela Velasco.png', 'Rec', 25, NULL),
(438, 'Pablo Rosso', 'img/ator-cards/Pablo Rosso.png', 'Rec', 25, NULL),
(439, 'Jorge Yamam', 'img/ator-cards/Jorge Yamam.png', 'Rec', 25, NULL),
(440, 'Ferran Terraza', 'img/ator-cards/Ferran Terraza.png', 'Rec', 25, NULL),
(441, 'David Vert', 'img/ator-cards/David Vert.png', 'Rec', 25, NULL),
(442, 'Cho Yeo-Jeong', 'img/ator-cards/Cho Yeo-Jeong.png', 'Parasita', 28, NULL),
(443, 'Park So-dam', 'img/ator-cards/Park So-dam.png', 'Parasita', 28, NULL),
(444, 'Choi Woo-shik', 'img/ator-cards/Choi Woo-shik.png', 'Parasita', 28, NULL),
(445, 'Park Seo-Joon', 'img/ator-cards/Park Seo-Joon.png', 'Parasita', 28, NULL),
(446, 'Jung Ji-so', 'img/ator-cards/Jung Ji-so.png', 'Parasita', 28, NULL),
(447, 'Jason Bateman', 'img/ator-cards/Jason Bateman.png', 'Quero Matar meu Chefe 2', 30, NULL),
(448, 'Charlie Day', 'img/ator-cards/Charlie Day.png', 'Quero Matar meu Chefe 2', 30, NULL),
(449, 'Jason Sulideikis', 'img/ator-cards/Jason Sulideikis.png', 'Quero Matar meu Chefe 2', 30, NULL),
(450, 'Chris Pine', 'img/ator-cards/Chris Pine.png', 'Quero Matar meu Chefe 2', 30, NULL),
(451, 'Jennifer Aniston', 'img/ator-cards/Jennifer anniston.jpg', 'Quero Matar meu Chefe 2', 30, NULL),
(452, 'Petra costa', 'img/ator-cards/Petra costa.png', 'Democracia em Vertigem', 31, NULL),
(453, '', 'img/ator-cards/.png', 'Democracia em Vertigem', 31, NULL),
(454, '', 'img/ator-cards/.png', 'Democracia em Vertigem', 31, NULL),
(455, '', 'img/ator-cards/.png', 'Democracia em Vertigem', 31, NULL),
(456, '', 'img/ator-cards/.png', 'Democracia em Vertigem', 31, NULL),
(457, 'Aram Hampariam', 'img/ator-cards/Aram Hampariam.png', 'Screamers', 32, NULL),
(458, 'Serj Tankian', 'img/ator-cards/Serj Tankian.png', 'Screamers', 32, NULL),
(459, 'Peter Weller', 'img/ator-cards/Peter Weller.png', 'Screamers', 32, NULL),
(460, 'Shavo Odajian', 'img/ator-cards/Shavo Odajian.png', 'Screamers', 32, NULL),
(461, 'Jennifer Rubin', 'img/ator-cards/Jennifer Rubin.png', 'Screamers', 32, NULL),
(462, 'Patrick Wilson', 'img/ator-cards/Patrick Wilson.png', 'Sobrenatural', 34, NULL),
(463, 'Leigh Whannell', 'img/ator-cards/Leigh Whannell.png', 'Sobrenatural', 34, NULL),
(464, 'Rose Byrne', 'img/ator-cards/Rose Byrne.png', 'Sobrenatural', 34, NULL),
(465, 'Lin Shaye', 'img/ator-cards/Lin Shaye.png', 'Sobrenatural', 34, NULL),
(466, 'Ty Simpkins', 'img/ator-cards/Ty Simpkins.png', 'Sobrenatural', 34, NULL),
(467, 'Leandro Hassum', 'img/ator-cards/Leandro Hassum.png', 'Até que a sorte nos separe', 35, NULL),
(468, 'Kiko Mascarenhas', 'img/ator-cards/Kiko Mascarenhas.png', 'Até que a sorte nos separe', 35, NULL),
(469, 'Ailton Graça', 'img/ator-cards/Ailton Graça.png', 'Até que a sorte nos separe', 35, NULL),
(470, 'Danielle Winits', 'img/ator-cards/Danielle Winits.png', 'Até que a sorte nos separe', 35, NULL),
(471, 'Julia Dalavia', 'img/ator-cards/Julia Dalavia.png', 'Até que a sorte nos separe', 35, NULL),
(472, 'Bill Skarsgard', 'img/ator-cards/Bill Skarsgard.png', 'It a coisa', 36, NULL),
(473, 'Jaeden Martell', 'img/ator-cards/Jaeden Martell.png', 'It a coisa', 36, NULL),
(474, 'Finn Wolfhard', 'img/ator-cards/Finn Wolfhard.png', 'It a coisa', 36, NULL),
(475, 'Sophia Lillis', 'img/ator-cards/Sophia Lillis.png', 'It a coisa', 36, NULL),
(476, 'Stephen King', 'img/ator-cards/Stephen King.png', 'It a coisa', 36, NULL),
(477, 'Tom Holland', 'img/ator-cards/Tom Holland.png', 'Homem-Aranha: Sem Volta para Casa', 37, NULL),
(478, 'Tobey Maguire', 'img/ator-cards/Tobey Maguire.png', 'Homem-Aranha: Sem Volta para Casa', 37, NULL),
(479, 'Tom Hardy', 'img/ator-cards/Tom Hardy.png', 'Homem-Aranha: Sem Volta para Casa', 37, NULL),
(480, 'Willem Dafoe', 'img/ator-cards/Willem Dafoe.png', 'Homem-Aranha: Sem Volta para Casa', 37, NULL),
(481, 'Zendaya Coleman', 'img/ator-cards/Zendaya Coleman.png', 'Homem-Aranha: Sem Volta para Casa', 37, NULL),
(482, 'Hugo Weaving', 'img/ator-cards/Hugo Weaving.png', 'V de Vingança', 38, NULL),
(483, 'Natalie Portman', 'img/ator-cards/Natalie Portman.png', 'V de Vingança', 38, NULL),
(484, 'Stephen Fry', 'img/ator-cards/Stephen Fry.png', 'V de Vingança', 38, NULL),
(485, 'John Hurt', 'img/ator-cards/John Hurt.png', 'V de Vingança', 38, NULL),
(486, 'Stephan Rea', 'img/ator-cards/Stephan Rea.png', 'V de Vingança', 38, NULL),
(487, 'Allan Cumming', 'img/ator-cards/Allan Cumming.png', 'O Filho do Máskara', 39, NULL),
(488, 'Jamie Kennedy', 'img/ator-cards/Jamie Kennedy.png', 'O Filho do Máskara', 39, NULL),
(489, 'Ryan Falconer', 'img/ator-cards/Ryan Falconer.png', 'O Filho do Máskara', 39, NULL),
(490, 'Traylor Howard', 'img/ator-cards/Traylor Howard.png', 'O Filho do Máskara', 39, NULL),
(491, 'Bob Hoskins', 'img/ator-cards/Bob Hoskins.png', 'O Filho do Máskara', 39, NULL),
(492, 'Letitia Wright', 'img/ator-cards/Letitia Wright.png', 'Pantera Negra Wakanda para sempre', 41, NULL),
(493, 'Angela Bassett', 'img/ator-cards/Angela Bassett.png', 'Pantera Negra Wakanda para sempre', 41, NULL),
(494, 'Tenoch Huerta', 'img/ator-cards/Tenoch Huerta.png', 'Pantera Negra Wakanda para sempre', 41, NULL),
(495, 'Daniel Kaluuya', 'img/ator-cards/Daniel Kaluuya.png', 'Pantera Negra Wakanda para sempre', 41, NULL),
(496, 'Danai Gurira', 'img/ator-cards/Danai Gurira.jpg', 'Pantera Negra Wakanda para sempre', 41, NULL),
(497, 'Bradley Cooper', 'img/ator-cards/Bradley cooper.png', 'Se Beber, Não Case', 42, NULL),
(498, 'Zach Galifianakis', 'img/ator-cards/Zach Galifianakis.png', 'Se Beber, Não Case', 42, NULL),
(499, 'Ed Helms', 'img/ator-cards/Ed Helms.png', 'Se Beber, Não Case', 42, NULL),
(500, 'Justin Bartha', 'img/ator-cards/Justin Bartha.png', 'Se Beber, Não Case', 42, NULL),
(501, 'Ken Jeong', 'img/ator-cards/Ken Jeong.png', 'Se Beber, Não Case', 42, NULL),
(502, 'Bradley Cooper', 'img/ator-cards/Bradley cooper.png', 'Sniper Americano', 45, NULL),
(503, 'Luke Grimes', 'img/ator-cards/Luke Grimes.png', 'Sniper Americano', 45, NULL),
(504, 'Marnette Patterson', 'img/ator-cards/Marnette Patterson.png', 'Sniper Americano', 45, NULL),
(505, 'Sammy Sheik', 'img/ator-cards/Sammy Sheik.png', 'Sniper Americano', 45, NULL),
(506, 'Siena Miller', 'img/ator-cards/Siena Miller.png', 'Sniper Americano', 45, NULL),
(507, 'Kang Ha-neul', 'img/ator-cards/Kang Ha-neul.png', 'Rastros de um Sequestro', 46, NULL),
(508, 'Lee Eun Woo', 'img/ator-cards/Lee Eun Woo.png', 'Rastros de um Sequestro', 46, NULL),
(509, 'Yeon Je-hyung', 'img/ator-cards/Yeon Je-hyung.png', 'Rastros de um Sequestro', 46, NULL),
(510, 'Na Young hee', 'img/ator-cards/Na Young hee.png', 'Rastros de um Sequestro', 46, NULL),
(511, 'Nam Myeong ryeol', 'img/ator-cards/Nam Myeong ryeol.png', 'Rastros de um Sequestro', 46, NULL),
(512, 'David Carradine', 'img/ator-cards/David Carradine.png', 'O Ovo da Serpente', 47, NULL),
(513, 'Liv Ulmann', 'img/ator-cards/Liv Ulmann.png', 'O Ovo da Serpente', 47, NULL),
(514, 'Heinz Bennent', 'img/ator-cards/Heinz Bennent.png', 'O Ovo da Serpente', 47, NULL),
(515, 'James Whitmore', 'img/ator-cards/James Whitmore.png', 'O Ovo da Serpente', 47, NULL),
(516, 'Toni berger', 'img/ator-cards/Toni berger.png', 'O Ovo da Serpente', 47, NULL),
(517, 'Pierce Brosnan', 'img/ator-cards/Pierce Brosnan.png', '007: Um Novo Dia Para Morrer', 48, NULL),
(518, 'Halle Berry', 'img/ator-cards/Halle Berry.png', '007: Um Novo Dia Para Morrer', 48, NULL),
(519, 'Toby Stephens', 'img/ator-cards/Toby Stephens.png', '007: Um Novo Dia Para Morrer', 48, NULL),
(520, 'Rosamund Pike', 'img/ator-cards/Rosamund Pike.png', '007: Um Novo Dia Para Morrer', 48, NULL),
(521, 'Samantha bond', 'img/ator-cards/Samantha bond.png', '007: Um Novo Dia Para Morrer', 48, NULL),
(522, 'Tom Cruise', 'img/ator-cards/Tom Cruise.png', 'Missão: Impossível 3', 49, NULL),
(523, 'Michelle Monaghan', 'img/ator-cards/Michelle Monaghan.png', 'Missão: Impossível 3', 49, NULL),
(524, 'Maggie Q', 'img/ator-cards/Maggie Q.png', 'Missão: Impossível 3', 49, NULL),
(525, 'Keri Russell', 'img/ator-cards/Keri Russell.png', 'Missão: Impossível 3', 49, NULL),
(526, 'Aaron Paul', 'img/ator-cards/Aaron Paul.jpg', 'Missão: Impossível 3', 49, NULL),
(527, 'Jim Carrey', 'img/ator-cards/Jim Carrey.png', 'Os Pinguins do Papai', 50, NULL),
(528, 'Claudia Gugino', 'img/ator-cards/Claudia Gugino.png', 'Os Pinguins do Papai', 50, NULL),
(529, 'Madeline Carroll', 'img/ator-cards/Madeline Carroll.png', 'Os Pinguins do Papai', 50, NULL),
(530, 'Ophelia Lovibond', 'img/ator-cards/Ophelia Lovibond.png', 'Os Pinguins do Papai', 50, NULL),
(531, 'Philip Barker Hall', 'img/ator-cards/Philip Barker Hall.png', 'Os Pinguins do Papai', 50, NULL),
(532, '', 'img/ator-cards/.png', 'Vingadores: Ultimato', 51, NULL),
(533, '', 'img/ator-cards/.png', 'Vingadores: Ultimato', 51, NULL),
(534, '', 'img/ator-cards/.png', 'Vingadores: Ultimato', 51, NULL),
(535, '', 'img/ator-cards/.png', 'Vingadores: Ultimato', 51, NULL),
(536, '', 'img/ator-cards/.png', 'Vingadores: Ultimato', 51, NULL),
(537, '', 'img/ator-cards/.png', 'Avatar: O Caminho da Água', 52, NULL),
(538, '', 'img/ator-cards/.png', 'Avatar: O Caminho da Água', 52, NULL),
(539, '', 'img/ator-cards/.png', 'Avatar: O Caminho da Água', 52, NULL),
(540, '', 'img/ator-cards/.png', 'Avatar: O Caminho da Água', 52, NULL),
(541, '', 'img/ator-cards/.png', 'Avatar: O Caminho da Água', 52, NULL),
(542, 'Tom Hardy', 'img/ator-cards/Tom Hardy.png', 'Venom', 53, NULL),
(543, '', 'img/ator-cards/.png', 'Venom', 53, NULL),
(544, '', 'img/ator-cards/.png', 'Venom', 53, NULL),
(545, '', 'img/ator-cards/.png', 'Venom', 53, NULL),
(546, '', 'img/ator-cards/.png', 'Venom', 53, NULL);
...
(15, 'Cracolândia', '0000-00-00', 'A partir de uma intensa pesquisa, o filme abre um debate a respeito da maior e mais impactante cena de uso aberto de crack do mundo: a \"Cracolândia\" de São Paulo. A obra analisa as causas desse mal e suas progressões, além das táticas de combate já realizadas em São Paulo, abrindo um paralelo com as estratégias usadas em outros países.', 'img/film-cards/Cracolandia.jpg', '12', '10', 'https://www.youtube.com/embed/CBBPbzJyeag', 1),
(16, 'A culpa é das estrelas', '0000-00-00', 'Hazel Grace Lancaster e Augustus Waters são dois adolescentes que se conhecem em um grupo de apoio para pacientes com câncer. Por causa da doença, Hazel sempre descartou a ideia de se envolver amorosamente, mas acaba cedendo ao se apaixonar por Augustus. Juntos, eles viajam para Amsterdã, onde embarcam em uma jornada inesquecível.', 'img/film-cards/Estrelas.jpg', '12', '10', 'https://www.youtube.com/embed/lFOOZJ1UChg', 1),
(17, 'O Regresso', '0000-00-00', 'Após ser atacado por um urso, o caçador Hugh Glass é abandonado na floresta por seu companheiro John Fitzgerald. Apesar de muito ferido, Glass consegue sobreviver e vai em busca de vingança.', 'img/film-cards/Regresso.jpg', '16', '10', 'https://www.youtube.com/embed/', 1),
...
(44, 'Adão Negro', '0000-00-00', 'O poderoso Adão Negr o é libertado de sua tumba para lançar sua justiça cruel sobre a Terra.', 'img/film-cards/Adao.jpeg', '14', '10', 'https://www.youtube.com/embed/HluMG9tJXHM', 1),
...
(51, 'Vingadores: Ultimato', '2019', 'Após os eventos devastadores de Vingadores: Guerra Infinita, o Universo entrou em destruição por causa do Estalar de Dedos do Thanos, o Titã Louco. Com a ajuda dos heróis sobreviventes, os Vingadores devem se reunir mais uma vez para desfazer as ações de Thanos e restaurar a ordem do universo de uma vez por todas, não importa quais serão as consequências que os aguardam.', 'img/film-cards/avengers.jpg', '12', '4,3', 'https://www.youtube.com/embed/gosFJSkg-gk', 1),
(52, 'Avatar: O Caminho da Água', '2022', 'Doze anos depois de explorar Pandora e se juntar aos Navi, Jake Sully formou uma família com Neytiri e se estabeleceu entre os clãs do novo mundo. No entanto, o retorno de um antigo conhecido em busca de vingança faz com que seja necessária uma brusca mudança para o casal e seus filhos, agora que a guerra está declarada.', 'img/film-cards/avatar2.jpg', '14', '4.1', 'https://www.youtube.com/embed/x5pZI-DmtrE ', 1),
(53, 'Venom', '2018', 'Eddie Brock (Tom Hardy) é um jornalista que investiga o misterioso trabalho de um cientista, suspeito de utilizar cobaias humanas em experimentos mortais. Quando ele acaba entrando em contato com um simbionte alienígena, Eddie se torna Venom, uma máquina de matar incontrolável, que nem ele pode conter.', 'img/film-cards/venom.jpg', '14', '3,1', 'https://www.youtube.com/embed/EQxCycVTfcU', 1);
...
(1, 'Clickbait', '2021', 'Uma coleção de histórias que explora as maneiras pelas quais nossos impulsos mais perigosos e descontrolados são alimentados na era das mídias sociais e revela as fraturas cada vez maiores que encontramos entre nossas personalidades da vida virtual e da vida real.', 'img/series-cards/clickbait.jpg', '16', '10', 'https://www.youtube.com/embed/_-jXBimnRd4', 1),
(2, 'Falando com um serial killer: teddy bundy', '2019', 'Entrevistas atuais, material de arquivo e gravações de áudio feitas no corredor da morte traçam o perfil do notório serial killer Ted Bundy.', 'img/series-cards/Serial.jpg', '14', '10', 'https://www.youtube.com/embed/YbkB9hjJviI', 1),
...
(9, 'Euphoria', '2019', 'O dia-a-dia de um grupo de estudantes do ensino médio, a medida que eles exploram novos amores e amizades em um mundo de sexo, drogas, traumas e mídias sociais.', 'img/series-cards/euphoria.jpg', '18', '10', 'https://www.youtube.com/embed/6XGnv7Zgbeg', 1),
(10, 'Squid Game - Round 6', '2021', 'Por meio um convite misterioso, um grupo de 456 pessoas, falidas e fracassadas na vida, recebem uma tentadora chance em participar da competição onde apenas um vai ganhar o prêmio milionário. O jogo é inspirado em brincadeiras infantis, mas com consequências mortais que nem imaginam.', 'img/series-cards/round6.jpg', '18', '10', 'https://www.youtube.com/embed/xqkmwzZMy7Q', 1),
(11, 'La casa de Papel', '2017', 'Oito ladrões se trancam com reféns na Casa da Moeda da Espanha. Seu líder manipula a polícia para realizar um plano. Será o maior roubo da história, ou uma missão em vão?', 'img/series-cards/lacasadepapel.jpg', '16', '10', 'https://www.youtube.com/embed/iS5xXr-GOnM', 1),
(12, 'Pacificador', '2022', 'A série explorará as origens do Pacificador, um homem que acredita na paz a qualquer custo – não importa quantas pessoas ele tenha que matar para obtê-la.', 'img/series-cards/peacemaker.png', '18', '10', 'https://www.youtube.com/embed/mlhXY6XUWBE', 1),
...
(14, 'Rick e Morty', '2022', 'Uma série animada que acompanha as aventuras e os descobrimentos de um super cientista e seu neto não muito brilhante.', 'img/series-cards/rickemorty.jpg', '16', '10', 'https://www.youtube.com/embed/6Zt15L7Gy3U', 1),
(15, 'Elite', '2018', 'Após um terremoto destruir uma escola pública, o governo envia três adolescentes de classe operária para Las Encinas, uma das melhores e mais caras escolas do país, frequentada pelos filhos da elite espanhola. O confronto entre aqueles que têm tudo e aqueles que não têm nada a perder cria uma atmosfera carregada e acaba levando a um assassinato. Quem estará por trás do crime?', 'img/series-cards/elite.png', '18', '10', 'https://www.youtube.com/embed/Oqv81BdRs7w', 1),
...
(18, 'The Mandalorian', '2019', 'Após as histórias de Jango e Boba Fett, outro guerreiro emerge do universo Star Wars. The Mandalorian é situado 5 anos após a queda do Império e antes da ascensão da Primeira Ordem. Nós seguimos as viagens de um pistoleiro solitário nos confins mais profundos da galáxia, longe da autoridade da Nova República.', 'img/series-cards/Mandalorian.jpg', '14', '10', 'https://www.youtube.com/embed/tN7fnIOVYLI', 1),
...
(40, 'Des(encanto)', '0000-00-00', 'Esta série de animação de Matt Groenign acompanha as malucas aventuras de uma princesa boa de copo em um reino medieval repleto de criaturas míticas.', 'img/series-cards/Des(encanto).jpg', '10', '10', 'https://www.youtube.com/embed/Dkgw8A-XiO0', 1),
(41, 'All of us are Dead', '2022', 'All of Us Are Dead é sobre um grupo de estudantes do ensino médio que enfrentam uma situação extrema de crise quando ficam presos na escola, enquanto um vírus zumbi se espalha como um incêndio. Adaptado do webtoon coreano chamado Now at Our School', 'img/series-cards/Dead.jpg', '16', '10', 'https://www.youtube.com/embed/bmbl65oiUgA', 1),
(42, 'The Umbrella Academy', '2019', 'Baseada na premiada série de quadrinhos com roteiro de Gerard Way e arte do brasileiro Gabriel Bá. A série acompanha um grupo superpoderoso de integrantes criados quando crianças para se tornarem heróis, pelo enigmático Sir Reginald Hargreeves. Nos dias de hoje, adultos, eles se encontram divididos e têm que se reunir para enfrentar um dos seus.', 'img/series-cards/Academy.jpg', '16', '10', 'https://www.youtube.com/embed/5_4SW8HHfUs', 1),
(43, 'Sex Education', '2019', 'Otis Thompson (Asa Butterfield) é um virgem com ansiedade social que é filho de uma terapeuta sexual (Gillian Anderson). Por ter crescido cercado por manuais, vídeos e conversas abertas sobre sexualidade, ele torna-se um expert no assunto - mesmo que contra sua vontade. Com a ajuda de Maeve (Emma Mackey), ele inicia uma clínica clandestina dentro da escola, ajudando os colegas com problemas sexuais em troca de dinheiro.', 'img/series-cards/Sex.jpg', '16', '10', 'https://www.youtube.com/embed/Jv46AlQUto4', 1),
