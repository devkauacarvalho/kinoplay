...
(10, 'Squid Game - Round 6', '2021', '', '', 'Por meio um convite misterioso, um grupo de 456 pessoas, falidas e fracassadas na vida, recebem uma tentadora chance em participar da competição onde apenas um vai ganhar o prêmio milionário. O jogo é inspirado em brincadeiras infantis, mas com consequências mortais que nem imaginam.', 'img/series-cards/round6.jpeg', '18', 'https://www.youtube.com/embed/xqkmwzZMy7Q'),
(11, 'La casa de Papel', '2017', '', '', 'Oito ladrões se trancam com reféns na Casa da Moeda da Espanha. Seu líder manipula a polícia para realizar um plano. Será o maior roubo da história, ou uma missão em vão?', 'img/series-cards/lacasadepapel.jpeg', '16', 'https://www.youtube.com/embed/iS5xXr-GOnM'),
(12, 'Pacificador', '2022', '', '', 'A série explorará as origens do Pacificador, um homem que acredita na paz a qualquer custo – não importa quantas pessoas ele tenha que matar para obtê-la.', 'img/series-cards/peacemaker.jpeg', '18', 'https://www.youtube.com/embed/mlhXY6XUWBE'),
(13, 'Lupin', '2021', '', '', '25 anos atrás, Assane Diop (Omar Sy) viu sua vida virar de cabeça para baixo com a morte de seu pai, então acusado injustamente de um crime. Agora, ele está em busca de vingança e, para isso, se inspira em Arsène Lupin, o famoso \"ladrão de casaca\" da literatura francesa. Conhecido como \"Robin Hood da Belle Époque\", Lupin se tornou um gênio do crime na Paris do início do século 20 - e Diop vai seguir seus passos nos dias de hoje.', 'img/series-cards/lupin.jpeg', '16', 'https://www.youtube.com/embed/FoiQ-Xr8NDI'),
(14, 'Rick e Morty', '2022', '', '', 'Uma série animada que acompanha as aventuras e os descobrimentos de um super cientista e seu neto não muito brilhante.', 'img/series-cards/rickemorty.jpeg', '16', 'https://www.youtube.com/embed/6Zt15L7Gy3U'),
(15, 'Elite', '2018', '', '', 'Após um terremoto destruir uma escola pública, o governo envia três adolescentes de classe operária para Las Encinas, uma das melhores e mais caras escolas do país, frequentada pelos filhos da elite espanhola. O confronto entre aqueles que têm tudo e aqueles que não têm nada a perder cria uma atmosfera carregada e acaba levando a um assassinato. Quem estará por trás do crime?', 'img/series-cards/elite.jpeg', '18', 'https://www.youtube.com/embed/Oqv81BdRs7w'),
(16, 'The Crown', '2016', '', '', 'Filha do rei George VI (Jared Harris), Elizabeth II (Claire Foy) sempre soube que não teria uma vida comum. Após a morte do seu pai em 1952, ela dá seus primeiros passos em direção ao trono inglês, a começar pelas audiências semanais com os primeiro-ministros ingleses. Ela assume a coroa com apenas 25 anos de idade, mas com grandes compromissos, vêm grandes responsabilidades.', 'img/series-cards/thecrown.jpeg', '14', 'https://www.youtube.com/embed/45qeTXa0P-c'),
(17, 'American Horror Story', '2011', '', '', 'A história apresenta Ben Harmon, um terapeuta que, após ter uma relação extraconjugal, decide salvar seu casamento. Assim, ele se muda com a esposa Vivien e a filha Violet para uma nova casa. Mas logo eles se envolvem com os estranhos personagens que fazem parte do lugar. Entre eles, Moira O’Hara, a governanta, que é vista por cada um como duas pessoas diferentes. Tem também Constance, uma vizinha intrometida; e o esquisito Larry. Para desespero do pai, Violet se envolve com Tate, um de seus pacientes, que ele acredita ter tendências homicidas.', 'img/series-cards/American.jpeg', '18', 'https://www.youtube.com/embed/xBo1KPQl0Gg'),
(18, 'The Mandalorian', '2019', '', '', 'Após as histórias de Jango e Boba Fett, outro guerreiro emerge do universo Star Wars. The Mandalorian é situado 5 anos após a queda do Império e antes da ascensão da Primeira Ordem. Nós seguimos as viagens de um pistoleiro solitário nos confins mais profundos da galáxia, longe da autoridade da Nova República.', 'img/series-cards/Mandalorian.jpeg', '14', 'https://www.youtube.com/embed/tN7fnIOVYLI'),
(19, 'Lucifer', '2016', '', '', 'Entediado e infeliz como o Senhor do inferno, Lúcifer (Tom Ellis) abdica seu trono e abandona seu reinado para viver na atordoada Los Angeles. Lá, ele dá início a outro empreendimento: um Piano-Bar chamado Lux.', 'img/series-cards/Lucifer.jpeg', '16', 'https://www.youtube.com/embed/Nu5z3AT2jv8'),
(20, 'Vikings', '2013', '', '', 'A história acompanha as aventuras do guerreiro nórdico Ragnar Lodbrok, figura histórica que viveu no período Medieval. Considerando-se descendente de Odin, Ragnar busca dominar vários territórios da Europa. Com isso, ele enfrenta a oposição de Earl Haraldson, ex-guerreiro e agora líder de seu povo, casado com Siggy, uma jovem que tem sua lealdade dividida.', 'img/series-cards/Vikings.jpeg', '16', 'https://www.youtube.com/embed/9GgxinPwAGc'),
(21, 'Game of thrones', '2011', '', '', 'Game of Thrones, se passa em Westeros, uma terra remanescente da Europa Medieval, onde as estações duram por anos ou até mesmo décadas. A história gira em torno de uma batalha entre os Sete Reinos, onde duas famílias dominantes estão lutando pelo controle do Trono de Ferro, cuja posse assegura a sobrevivência durante o inverno de 40 anos que está por vir.', 'img/series-cards/goty.jpeg', '16', 'https://www.youtube.com/embed/KPLWWIOCOOQ'),
(22, 'DR House', '2004', '', '', 'O Dr. Gregory House (Hugh Laurie), é um brilhante profissional da área médica, desprovido de boas maneiras e nem ao menos falaria com os seus pacientes se não fosse preciso. Tendo que lidar com sua própria dor física constante, ele utiliza uma bengala que parece acentuar sua acidez, comportamento rude e brutalmente honesto. Embora a sua conduta possa ser taxada de extremamente antisocial, House é um especialista cujo raciocínio não é nada convencional e possui instinto certeiro que permite que ele seja respeitado por todos. É especialista em doenças infecciosas, que realiza diagnósticos brilhantes e ama os desafios do quebra-cabeça médico. Em cada episódio, House encara um novo paciente, com sintomas inexplicáveis, e junto de sua equipe de médicos dedicados e enfermeiras, ele deve descobrir misteriosos diagnósticos...antes que seja tarde!', 'img/series-cards/house.jpeg', '14', 'https://www.youtube.com/embed/dVlQJO4HZj0'),
(23, 'The big bang theory', '2007', '', '', 'Leonard e Sheldon são físicos brilhantes que entendem como o universo funciona. Mas nada dessa inteligência ajuda os dois a interagir com as pessoas. Tudo isso começa a mudar quando uma jovem bela e liberal chamada Penny se muda para o apartamento ao lado.\r\n\r\nSheldon, o colega de quarto de Leonard, contenta-se a passar as noites jogando com os amigos socialmente disfuncionais dos dois, os cientistas Wolowitz e Koothrappali. Mas Leonard vê em Penny todo um novo universo de possibilidades... incluindo o amor.', 'img/series-cards/TBBT.jpeg', '12', 'https://www.youtube.com/embed/rCj-Fb1OmXg'),
(24, 'Young Sheldon', '2017', '', '', 'Prequel de The Big Bang Theory que acompanha a vida de Sheldon Cooper aos 9 anos de idade, vivendo com sua família no leste do Texas e entrando no Ensino Médio.', 'img/series-cards/Young.jpeg', '12', 'https://www.youtube.com/embed/Kwf2_kpOUvs'),
(25, 'Modern Family', '2009', '', '', 'Você consegue acreditar que todos eles são parentes? Nem eles! Com um elenco de astros e estrelas encabeçando por Ed O`Neill, Sofia Vergara, Julie Bowen e Ty Burrell, \"Modern Family\" nos traz uma divertida e inovadora visão do que significa criar uma família nesta época doida em que vivemos. Relacionamentos multiculturais, adoção e casamento de pessoas do mesmo sexo são apenas alguns dos assuntos atuais abordados por esta série que os analisa de modo divertido e sensível. Não importa o tamanho ou a formação, a família sempre vem no primeiro neste hilário modo de olhar \"moderno\" que foca a vida, o amor e as gargalhadas.', 'img/series-cards/Modern.jpeg', '10', 'https://www.youtube.com/embed/Ub_lfN2VMIo'),
(26, 'The Walking Dead', '2010', '', '', 'O mundo vive momentos de caos, quando o xerife Rick Grimes (Andrew Lincoln) acorda, depois de passar muito tempo em coma num hospital. Mal sabe ele que nada mais é como costumava ser. Assustadoramente, o improvável aconteceu e o apocalipse chegou com uma assustadora invasão de mortos-vivos.', 'img/series-cards/TWD.jpeg', '16', 'https://www.youtube.com/embed/R1v0uFms68U'),
