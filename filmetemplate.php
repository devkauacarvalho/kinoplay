<?php
    ...
    $ator = "SELECT Ator FROM elenco WHERE id = $id";
...
/*     $filme_elenco = "SELECT image_Ator FROM elenco WHERE id = $id"; */
    ...
    $result_fator = mysqli_query($conn, $ator);
    ...
    $row7 = mysqli_fetch_assoc($result_fator);
...
<body>
    ...
    <?php echo $fclassificacao; ?>
        ...
        $felenco = "SELECT elenco.image_Ator,elenco.idFilmes
        FROM elenco
        INNER JOIN filmes ON elenco.idFilmes=filmes.id limit 5";
